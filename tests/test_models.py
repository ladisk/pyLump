...
def test_matrices():
    # both:
    model = models.Model(3, 1, 1, 1, boundaries="both")
    ...
    # left
    model = models.Model(3, 1, 1, 1, boundaries="left")
    ...
    # right:
    model = models.Model(3, 1, 1, 1, boundaries="right")
    ...
    # free
    model = models.Model(3, 1, 1, 1, boundaries="free")
